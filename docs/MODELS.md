...
| コース適性（中山） | 20% | 中山競馬場での過去成績 |
| 距離適性 | 15% | 2200m以上の長距離での成績 |
| 上がり3F能力 | 15% | レース終盤での差し・追い込み能力 |
| G1実績 | 15% | G1レースでの入賞実績 |
| ローテ適性 | 10% | 出走間隔と成績の関係 |
...
```
総合スコア = (直近成績 × 0.25) + (コース適性 × 0.20) + (距離適性 × 0.15) +
...
| 4 | nakayamaPlaceRate | 中山での複勝率 | 0〜1 |
| 5 | jockeyNakayamaG1WinRate | 騎手の中山G1勝率 | 0〜1 |
| 6 | age | 馬齢 | 2〜10 |
